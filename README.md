...
This is a sample template for alexa-cloud-shiritori - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name alexa-cloud-shiritori \
...
aws cloudformation describe-stacks \
    --stack-name alexa-cloud-shiritori --query 'Stacks[].Outputs'
```
